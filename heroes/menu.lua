...
local Heroes = { --Declare new Quest type
    ...
    return {"heroes.mission_type", {key="heroes.quest_description_1", params={Config.barb_gems}, plural=Config.barb_gems}, "heroes.quest_description_2", "heroes.quest_description_3"}
	end,
	settings = { 
		mission = "heroespp",
		book = "none",
...
base.quest_table.Heroes = Heroes --Add this new quest type to the quests table
table.insert(base.quest_order, "Heroes") --Put it's name into another table
